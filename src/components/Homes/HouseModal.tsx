...
import { X, Home as HomeIcon, Save, Landmark, Check, ImageOff } from 'lucide-react';
      ...
      <div className={`border rounded-3xl w-full max-w-xl overflow-hidden shadow-2xl my-8 animate-modal ${
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto custom-scrollbar">
          ...
          <div>
            ...
            {/* Live Preview */}
            {hasImage && !imageError && (
              <div className="relative mb-2 rounded-2xl overflow-hidden border" style={{ height: '160px' }}>
                <img
                  src={photoUrl}
                  alt="Home preview"
